            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center mt-4">
                            <div class="mb-3">
                                <a href="index.html" class="auth-logo">
                                    <img src="{{ asset('images/logo.png') }}" height="70" class="logo-dark mx-auto" alt="">
                                    <img src="{{ asset('images/logo.png') }}" height="70" class="logo-light mx-auto" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <!-- Session Status -->
                           <x-auth-session-status class="mb-4 text-info text-center text-lg" :status="session('status')" />
